wage_analysis <- tabPanel(
  ...
  p("The map below shows the GDP differences between states. The state with the highest GDP is Washington, and the state with the lowest GDP is Connecticut. 
    Therefore, our project chose these two states and compare it with national employment data."),
  br(),
  br(),
  tags$section(id = "first_part",
  ...
  br(),
  br(),
  tags$section(id = "third_part",
               h3("Employment number in WA and CT"),
               textOutput("analysis_3")
               ),
